        ...
        <View style={{borderColor:"hsl(169, 54%, 47%)", borderWidth:6, width:"100%", height:510, borderRadius:40, backgroundColor:"hsl(166, 63%, 41%)"}}>
            ...
            <View style={{width:"100%", height:"55%", display:"flex", flexDirection:"row", borderTopLeftRadius:40, borderTopRightRadius:40}}>
                <View style={{width:"30%", paddingTop:20, display:"flex", alignItems:"center"}}>
                    <Text style={{fontSize:55, fontFamily:"NunitoSans_700Bold", letterSpacing:2}}>9</Text>
                    <Text fontSize={{fontSize:25, fontFamily:"NunitoSans_700Bold", letterSpacing:2}}>CMD</Text>
            ...
            <View style={{height:40, backgroundColor:"hsl(210, 18%, 13%)", borderWidth:1, borderColor:"black", display:"flex", justifyContent:"center", paddingLeft:10}}><Text style={{fontSize:25, color:"white", fontWeight:"bold", letterSpacing:4, fontFamily:"NunitoSans_700Bold", }}>SANTIAGO</Text></View>
