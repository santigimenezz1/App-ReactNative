    ...
    return (
        <View style={styles.container__tarjetaPerfil}>
            <View style={styles.container__info}>
                <View style={{width:"100%", height:210, display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
                    ...
                    <Image width={200} height={"100%"} style={{objectFit:"cover", borderRadius:4}} source={{uri:"https://res.cloudinary.com/dcf9eqqgt/image/upload/v1720655011/images_maavxo.jpg"}}></Image>
                </View>
