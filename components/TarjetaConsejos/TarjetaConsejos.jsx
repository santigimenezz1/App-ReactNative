...
const TarjetaConsejos = () => {
    return (
        <View style={styles.container__tarjetaConsejos}>
            ...
            <FontAwesome name="calendar-check-o" size={24} color="hsl(160, 54%, 47%)" />  
                      <View style={{width:"80%"}}>
            ...
            <View style={styles.container__consejos}>
            <AntDesign name="clockcircleo" size={24} color="hsl(160, 54%, 47%)" />           
             <View style={{width:"80%"}}>
            ...
            <View style={styles.container__consejos}>
            <FontAwesome6 name="person-running" size={24} color="hsl(160, 54%, 47%)" />   
                     <View style={{width:"80%"}}>
